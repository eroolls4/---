...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult AddUserToRole()
        {
            ...
            var usersWithoutRole = UserManager.Users.Where(u => u.Roles.Count == 0).ToList();
            foreach (var item in usersWithoutRole)
            {
                model.AllEmails.Add(item.Email.ToString());
            }
        ...
        public async Task<ActionResult> AddUserToRole(AddUserToRoleViewModel  model)
        {
            ...
            return RedirectToAction("Index", "Apartmen");
        }
